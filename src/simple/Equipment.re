...
let createEquipable = (attackModifier, hpModifier, equipmentType ) => { equipmentType: equipmentType, attackModifier: attackModifier, hpModifier: hpModifier}
...
let creatEquipment = (leftArm, rightArm) => { leftArm: leftArm, rightArm: rightArm  } 
...
let equip = (equipment: equipment, equipable: equipable) => 
    ...
    | RightArm =>  { 
        ...equipment, 
        leftArm: equipment.leftArm.equipmentType == TwoHanded ? createItem(EmptyLeftArm): equipment.leftArm, 
        rightArm: equipable 
        } 
    | TwoHanded => { ...equipment, leftArm: equipable, rightArm: createItem(EmptyRightArm) }
    | Any => equipment
    }

let getStatTotal = (statGetter: equipable => int, equipment: equipment) => statGetter(equipment.leftArm) + statGetter(equipment.rightArm);
